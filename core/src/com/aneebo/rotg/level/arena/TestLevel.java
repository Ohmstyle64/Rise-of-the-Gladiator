...
//		r1e1.add(new StatComponent("Close_Enemy_1", "Male", 25f, 60f, Color.YELLOW, 2f, 2f, 1.5f, false));
//		r1entities.add(r1e1);
//		
...
//		r1e3.add(new StatComponent("Close_Enemy_2", "Male", 25f, 60f, Color.YELLOW, 2f, 2f, 1.5f, false));
//		r1entities.add(r1e3);
//		
...
//		r2e1.add(new StatComponent("Range_Enemy_1", "Male", 25f, 60f, Color.YELLOW, 2f, 2f, 1.3f, false));
//		r2entities.add(r2e1);
//		
...
//		r3e1.add(new StatComponent("Enemy3", "Male", 45f, 50f, Color.YELLOW, 2f, 2f, 1.3f, false));
//		r3entities.add(r3e1);
//		
...
//		r3e2.add(new StatComponent("Enemy3", "Male", 45f, 50f, Color.YELLOW, 2f, 2f, 1.3f, false));
//		r3entities.add(r3e2);
//		
