...
public class NotifyRoomListener implements NotifyListener {
	
	private ServerRequestController callback;
	
	public NotifyRoomListener(ServerRequestController callback) {
	...
	public void onUpdatePeersReceived(UpdateEvent arg0) {
		callback.onSendUpdatePeersDone(arg0);
	}
