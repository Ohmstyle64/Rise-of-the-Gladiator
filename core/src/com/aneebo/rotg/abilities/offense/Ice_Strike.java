...
public class Ice_Strike extends Ability {

	public Ice_Strike(int id, float castTime, float range, AbilityType type,
	...
	public Ice_Strike(Ability ability, Engine engine) {
